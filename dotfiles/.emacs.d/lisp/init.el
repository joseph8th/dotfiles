...
;;(setq load-path (cons "~/.emacs.d/lisp/org-confluence" load-path))
...
;; 256 colors maybe?
(setq load-path (cons "~/.emacs.d/lisp/term" load-path))
...
(defun install-wanted-packages ()
  ...
  (cond
   ...
   ;; el-get
   ((string= pmoc "el-get")
    (add-to-list 'load-path "~/.emacs.d/lisp/el-get/el-get")
